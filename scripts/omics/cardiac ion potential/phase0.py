...
PHASE_TO_PLOT = "Phase 0"
OUTPUT_PDF = "Normal_vs_HF_Phase0_mirrored_DESeq2_heatmap.pdf"
...
def main():
    ...
    if df.empty:
        raise ValueError(
            "No usable DESeq2 values found for Phase 0."
        )
    ...
    title_ax.text(
        0.5,
        0.70,
        "Phase 0 Differential-Expression Heatmap: Normal vs Heart Failure",
        ha="center",
        va="center",
        fontsize=15,
        fontweight="bold"
