...
PHASE_TO_PLOT = "Phase 1"
OUTPUT_PDF = "Normal_vs_HF_Phase1_mirrored_DESeq2_heatmap.pdf"
...
def main():
    ...
    if df.empty:
        raise ValueError(
            "No usable DESeq2 values found for Phase 1."
        )
    ...
    title_ax.text(
        0.5,
        0.70,
        "Phase 1 Differential-Expression Heatmap: Normal vs Heart Failure",
        ha="center",
        va="center",
        fontsize=15,
        fontweight="bold"
